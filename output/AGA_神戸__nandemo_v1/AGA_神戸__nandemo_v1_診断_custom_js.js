(function(){
  ...
  const clinics = {
    'clinicfor': {
      ...
      reason: 'オンライン診療実績600万件以上を持つ大手クリニックグループのオンライン診療サービスで、神戸エリアからも自宅・職場で診療と処方が完結します。診察料無料、定期配送のクーポン適用で予防プラン月1,049円〜とコスパが高く、副作用時の全額返金制度もあるため初めてのAGA治療でも始めやすいのが特徴です。',
      features: [
    ...
    'dmm': {
      name: 'DMMオンラインクリニック',
      reason: 'スマホ完結のオンライン専門クリニックで、神戸エリアからも全国どこからでも自宅で診療と処方が完結します。診察料が無料、月額もリーズナブルな設定で、コスパと利便性を最大限重視する方に最適です。',
      features: [
        'オンライン完結で通院時間ゼロ、お薬は最短当日発送',
        '診察料無料、12ヶ月プランで月額単価を大きく下げられる',
        '神戸エリア外への引越し・転勤があっても継続OK',
    ...
    'agaskin': {
      name: 'AGAスキンクリニック神戸院',
      reason: 'JR・阪急・阪神「三宮駅」から徒歩4分圏内のAGA・FAGA専門クリニックで、地下街「さんちか」直結で雨の日でも通いやすいアクセスです。男女別フロア・完全予約制で周囲の目を気にせず受けられる環境で、内服薬から独自の発毛薬「Rebirth」まで幅広いオーダーメイド治療に対応しています。本気でAGA治療に取り組みたい方に向いています。',
      features: [
        'JR・阪急・阪神三宮駅徒歩4分圏内・さんちか直結のアクセス',
    ...
    'leva': {
      name: 'レバクリ',
      reason: 'オンライン完結で長期継続しやすいコスパ重視のAGAクリニックです。予防プランは月1,349円〜、発毛プランは月1,650円〜と費用を抑えられ、2年目以降も同価格で続けられる点が大きな特徴です。LINEで気軽に予約・相談でき、神戸エリアからも自宅で診療と処方が完結します。',
      features: [
